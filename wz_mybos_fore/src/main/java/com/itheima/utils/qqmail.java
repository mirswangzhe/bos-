...
public class qqmail {  
    ...
    //发送的邮箱 内部代码只适用qq邮箱  
    private static final String USER = "729778837@qq.com";  
    //授权密码 通过QQ邮箱设置->账户->POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务->开启POP3/SMTP服务获取  
    private static final String PWD = "hksdrxxpjzupbdcf";  
    ...
    public static void main(String args[]) {  
        ...
        mail.setTo(new String[] {"1783024950@qq.com","1782959314@qq.com"});  
        //抄送  
        //mail.setCc(new String[] {"729778837@qq.com","729778837@qq.com"});  
        //密送  
        //mail.setBcc(new String[] {"729778837@qq.com","729778837@qq.com"});  
        //发送附件列表 可以写绝对路径 也可以写相对路径(起点是项目根目录)  
      //  mail.setFileList(new String[] {"file\\D:\\中央仓库\\reposition\\bosWuLiu\\wz_mybos_fore\\pom.xml"});  
        //发送邮件  
        try {  
            mail.sendMessage();  

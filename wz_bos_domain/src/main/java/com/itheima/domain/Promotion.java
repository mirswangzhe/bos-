...
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		...
		return Constans.wz_bos_management_url+titleImg;
	}
	...
	public String getDescription() {
		if(description.contains(Constans.wz_bos_management_url+"/wz_bos_management")){
			return description;
		}
		return description.replace("src=\"/wz_bos_management","src=\""+Constans.wz_bos_management_url+"/wz_bos_management");
	}
